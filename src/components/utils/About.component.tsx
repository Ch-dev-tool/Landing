...
export default function About() {
    return (
        <section className="py-20 bg-[#1e2836] text-white" id="AboutSection">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="tracking-tight text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
                        About <span className="text-[#fca700]">{StartupName}</span>
                    </h2>
                    ...
                    <Card className="bg-[#2d3748] shadow-md text-gray-100">
                        <CardHeader>
                            <CardTitle className="text-2xl font-bold">
                                <span className="text-[#fca700]">M</span>eet the <span className="text-[#fca700]">F</span>ounder
                            </CardTitle>
                        </CardHeader>
                        <CardContent className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-50 mb-4">
                                    ...
                                    Diouri Salah Eddine founded <span className="text-[#fca700] font-semibold ">{StartupName}</span> to revolutionize the way developers work. His vision
                                ...
                                <p className="text-gray-50">
                                    "I believe that by harnessing the power of software and AI, we can unlock new levels of
                                    efficiency and innovation in software development. <span className="text-[#fca700] font-semibold ">{StartupName}</span> is just the
